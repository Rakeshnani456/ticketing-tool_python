            ...
            <div className="space-y-6 max-w-4xl mx-auto">
                ...
                <div className={`p-6 rounded-lg shadow-xl border ${theme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
                    <div className="flex items-center space-x-3 mb-4">
                        ...
                        <div>
                            <h3 className={`text-lg font-semibold ${theme === 'dark' ? 'text-gray-100' : 'text-gray-800'}`}>Data & Privacy</h3>
                            <p className={`text-sm ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>Control your data and privacy settings</p>
                        </div>
                    </div>
                    <p className={`mb-4 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>
                        Manage your data export, account deletion, and privacy preferences.
                    </p>
                    <div className="space-y-3">
                        <PrimaryButton
