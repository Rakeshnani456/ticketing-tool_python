# IT Ticketing Tool - QA Testing Guide

## Overview
This document provides comprehensive testing procedures for the IT Ticketing Tool from both **User** and **Engineer** perspectives. QA testers should follow these test cases to ensure all functionalities work correctly across different user roles.
