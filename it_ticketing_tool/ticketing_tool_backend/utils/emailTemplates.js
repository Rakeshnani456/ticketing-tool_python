...
<head>
    ...
    <title>Kriasol Technologies Enterprise Ticketing System</title>
    <style>
...
<body>
    <div class="email-container">
        ...
        <div class="footer">
            <p>This is an automated message from the Kriasol Technologies Enterprise Ticketing System.</p>
            <div class="contact">
...
Welcome to the ${clientName || companyName} Enterprise Ticketing Portal, powered by Kriasol Technologies.
...
Thank you for partnering with Kriasol Technologies.
...
Kriasol Technologies LLP
    ...
    const htmlContent = createBaseTemplate(() => `
        ...
        <p>Welcome to the <strong>${clientName || companyName} Enterprise Ticketing Portal</strong>, powered by Kriasol Technologies.</p>
        ...
        <div class="success">
            <strong>Thank you for partnering with Kriasol Technologies.</strong>
        </div>
    `);
    return {
        subject,
...
const getPasswordResetTemplate = (userData) => {
    ...
    const subject = 'Password Reset Request - Kriasol Enterprise Ticketing System';
    const textContent = `
Dear ${userName},

We have received a password reset request for your account in the Kriasol Enterprise Ticketing System.
...
Kriasol Technologies LLP
    ...
    const htmlContent = createBaseTemplate(() => `
        ...
        <p>We have received a password reset request for your account in the <strong>Kriasol Enterprise Ticketing System</strong>.</p>
